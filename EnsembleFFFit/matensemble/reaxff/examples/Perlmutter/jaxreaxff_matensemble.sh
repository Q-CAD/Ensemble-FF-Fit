...
srun flux start jaxreaxff_matensemble --run_directory JaxReaxFF_test/run_directory --inputs_directory JaxReaxFF_test/inputs_directory --check_files geo train_file --num_e_minim_steps 200 --e_minim_LR 1e-4 --out_folder outputs --save_opt all --num_trials 1 --num_steps 5 --init_FF_type fixed 
