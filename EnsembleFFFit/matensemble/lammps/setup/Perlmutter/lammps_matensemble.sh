...
CONDA_ENV="/global/cfs/cdirs/m5014/conda_matensemble_env"
...
conda deactivate
conda activate /global/cfs/cdirs/m5014/conda_matensemble_env 

# Add conda environment to PYTHONPATH before the Spack path
export PYTHONPATH="${CONDA_SITE}:${FLUX_SITE}:${PYTHONPATH}"

srun flux start $CONDA_PYTHON lammps_matensemble.py \
                           --run_directory LAMMPS_test/run_directory \
                           --inputs_directory LAMMPS_test/inputs_directory
