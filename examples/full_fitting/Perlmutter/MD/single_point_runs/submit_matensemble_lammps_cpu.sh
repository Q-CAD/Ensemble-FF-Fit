...
srun flux start lammps_matensemble --run_directory run_directory --inputs_directory inputs_directory --atoms_per_task 10000 --batch --in_lammps in.batched --lammps_task lammps_task_batched.py
